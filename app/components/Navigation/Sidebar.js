      ...
      <div className='navbar'>
        <nav role='navigation' className={this.props.status}>
          ...
          <div className='social-links'>
            <SocialLink url='https://www.facebook.com/catedra.ru' imageName='facebook-logo-round.svg' alt='Facebook' />

            <SocialLink url='https://vk.com/catedra' imageName='vk-social-logotype-black.svg' alt='VK' />
