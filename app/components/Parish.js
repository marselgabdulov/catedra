  ...
  render() {
    return (
      <div className="ordinary-page">
        ...
        <p><NavLink exact activeClassName='active' to='/clergy'>
          СЛУЖИТЕЛИ
        </NavLink></p>

        <p><NavLink exact activeClassName='active' to='/catechesis'>КАТЕХИЗАЦИЯ И УГЛУБЛЕНИЕ ВЕРЫ.</NavLink> Катехизация (от греч. Κατήχησις — поучение, наставление) — изучение основ христианской веры и вероучения церкви человеком, как правило, готовящимся принять Крещение и стать членом Церкви... </p>

        <p>
          <NavLink exact activeClassName='active' to='/ministrant'>МИНИСТРАНТ</NavLink> - (лат. Ministrans, помощник, прислуживающий) - мирянин, помогающий священнику во время Мессы и других богослужений...
        </p>

        <p><NavLink exact activeClassName='active' to='/congregations'>ОРДЕНА И КОНГРЕГАЦИИ...</NavLink></p>
